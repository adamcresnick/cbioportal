...
/**
 * MyBatis mapper interface for executing clinical data queries against StarRocks.
 *
 * <p>This mapper provides SQL query execution methods optimized for StarRocks's column store
 ...
 */
public interface StarrocksClinicalDataMapper {
