package org.cbioportal.infrastructure.repository.starrocks.sample;
...
public class StarrocksSampleRepository implements SampleRepository {

  private final StarrocksSampleMapper mapper;

  public StarrocksSampleRepository(StarrocksSampleMapper starrocksSampleMapper) {
    this.mapper = starrocksSampleMapper;
  }
