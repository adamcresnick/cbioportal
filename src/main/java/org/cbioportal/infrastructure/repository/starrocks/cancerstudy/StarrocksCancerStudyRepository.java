package org.cbioportal.infrastructure.repository.starrocks.cancerstudy;
...
/**
 * Repository implementation for accessing cancer study metadata from StarRocks. This class
 * delegates database queries to {@link StarrocksCancerStudyMapper}.
 */
@Repository
...
public class StarrocksCancerStudyRepository implements CancerStudyRepository {

  private final StarrocksCancerStudyMapper cancerStudyMapper;

  /**
   * Constructs a new {@code StarrocksCancerStudyRepository} with the required mapper.
   *
   * @param cancerStudyMapper the mapper responsible for executing StarRocks queries
   */
  public StarrocksCancerStudyRepository(StarrocksCancerStudyMapper cancerStudyMapper) {
