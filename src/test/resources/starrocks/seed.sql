...
INSERT INTO clinical_attribute_meta VALUES
  ...
  ('ALL_NA','All NA','All values are missing','STRING',0,'7',1),
...
INSERT INTO clinical_data_derived VALUES
  ...
  (102,'','sr_study_a_PA2','AGE','12','sr_study_a','patient'),
  (102,'','sr_study_a_PA2','OS_MONTHS','36','sr_study_a','patient'),
  (102,'','sr_study_a_PA2','OS_STATUS','0:LIVING','sr_study_a','patient'),
  (103,'','sr_study_a_PA3','AGE','8','sr_study_a','patient'),
  (103,'','sr_study_a_PA3','OS_STATUS','0:LIVING','sr_study_a','patient'),
  ...
  (1001,'sr_study_a_SA1','sr_study_a_PA1','SPECIAL','NA','sr_study_a','sample'),
  (1002,'sr_study_a_SA2','sr_study_a_PA1','SUBTYPE','B','sr_study_a','sample'),
  (1002,'sr_study_a_SA2','sr_study_a_PA1','PURITY','0.55','sr_study_a','sample'),
  (1002,'sr_study_a_SA2','sr_study_a_PA1','SPECIAL','','sr_study_a','sample'),
  (1003,'sr_study_a_SA3','sr_study_a_PA2','SUBTYPE','A','sr_study_a','sample'),
  (1003,'sr_study_a_SA3','sr_study_a_PA2','PURITY','NA','sr_study_a','sample'),
  (1004,'sr_study_a_SA4','sr_study_a_PA3','SUBTYPE','C','sr_study_a','sample'),
  (1004,'sr_study_a_SA4','sr_study_a_PA3','PURITY','0.70','sr_study_a','sample'),
  (1004,'sr_study_a_SA4','sr_study_a_PA3','SPECIAL','available','sr_study_a','sample'),
  (1004,'sr_study_a_SA4','sr_study_a_PA3','ALL_NA','NA','sr_study_a','sample'),
  (201,'','sr_study_b_PB1','AGE','11','sr_study_b','patient'),
  (201,'','sr_study_b_PB1','OS_MONTHS','18','sr_study_b','patient'),
  (201,'','sr_study_b_PB1','OS_STATUS','1:DECEASED','sr_study_b','patient'),
  (202,'','sr_study_b_PB2','AGE','14','sr_study_b','patient'),
  (202,'','sr_study_b_PB2','OS_MONTHS','48','sr_study_b','patient'),
  (202,'','sr_study_b_PB2','OS_STATUS','0:LIVING','sr_study_b','patient'),
  (203,'','sr_study_b_PB3','AGE','9','sr_study_b','patient'),
  (203,'','sr_study_b_PB3','OS_MONTHS','NA','sr_study_b','patient'),
  (203,'','sr_study_b_PB3','OS_STATUS','0:LIVING','sr_study_b','patient'),
  (2001,'sr_study_b_SB1','sr_study_b_PB1','SUBTYPE','A','sr_study_b','sample'),
  (2001,'sr_study_b_SB1','sr_study_b_PB1','PURITY','0.75','sr_study_b','sample'),
  (2001,'sr_study_b_SB1','sr_study_b_PB1','SPECIAL','NA','sr_study_b','sample'),
  (2002,'sr_study_b_SB2','sr_study_b_PB1','SUBTYPE','B','sr_study_b','sample'),
  (2002,'sr_study_b_SB2','sr_study_b_PB1','PURITY','0.60','sr_study_b','sample'),
  (2002,'sr_study_b_SB2','sr_study_b_PB1','SPECIAL','','sr_study_b','sample'),
  (2003,'sr_study_b_SB3','sr_study_b_PB2','SUBTYPE','C','sr_study_b','sample'),
  (2003,'sr_study_b_SB3','sr_study_b_PB2','PURITY','0.65','sr_study_b','sample'),
  (2004,'sr_study_b_SB4','sr_study_b_PB3','SUBTYPE','A','sr_study_b','sample'),
  (2004,'sr_study_b_SB4','sr_study_b_PB3','PURITY','0.50','sr_study_b','sample'),
  (2004,'sr_study_b_SB4','sr_study_b_PB3','SPECIAL','available','sr_study_b','sample');
